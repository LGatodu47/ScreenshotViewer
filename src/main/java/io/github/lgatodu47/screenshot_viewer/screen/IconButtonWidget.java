...
public class IconButtonWidget extends ButtonWidget {
    ...
    protected void renderWidget(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        context.drawGuiTexture(ManageScreenshotsScreen.DEFAULT_BUTTON_TEXTURES.get(this.active, isSelected()), getX(), getY(), getWidth(), getHeight());
        context.drawGuiTexture(getIconTexture(), getX(), getY(), getWidth(), getHeight());
